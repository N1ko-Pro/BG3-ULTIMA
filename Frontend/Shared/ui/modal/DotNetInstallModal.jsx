...
export default function DotNetInstallModal({ isOpen, onInstall, onLater, onDismiss }) {
    ...
    try {
      await onInstall?.((progressValue) => {
        ...
        if (progressValue === -1) {
          ...
          // Change to installing status when download completes (100%)
  ...
  return createPortal(
    <div className="fixed inset-0 top-9 z-[250] flex items-center justify-center p-4" role="dialog" aria-modal="true">
      {/* Backdrop */}
      <div

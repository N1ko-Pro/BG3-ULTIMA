...
import { TIER_STYLES, ICON_COLORS, BORDER_COLORS, GLOW_COLORS } from './constants';
...
export function FeatureCard({ icon: Icon, title, desc, tier, color, index }) {
  ...
  return (
    ...
    >
      ...
      {/* Inner glow */}
      <div className="absolute inset-0 rounded-2xl pointer-events-none" style={{ background: 'radial-gradient(ellipse 70% 50% at 30% 20%, rgba(255,255,255,0.02) 0%, transparent 70%)' }} />
